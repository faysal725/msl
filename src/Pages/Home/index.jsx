            ...
            <section className='grid grid-cols-1 md:grid-cols-2 items-center justify-center max-w-7xl mx-auto px-6 md:px-16'>
                ...
                <div className='text-center md:text-left mb-16 md:mb-0 md:mt-6 lg:mt-0'>
                    ...
                    <div className='flex justify-center md:justify-start'>
                        <button className='rounded-full border border-theme_blue px-6 pt-2.5 pb-2 text-theme_blue transition-all hover:bg-theme_blue hover:text-white'>GET A QUOTE</button>
                    </div>
                </div>
                    ...
                    <div className='flex flex-col gap-6 mt-12'>
                        {
                            socials.map((social,index)=>
                                <div key={index} className="transition flex items-center pr-8 p-2.5 border-l-8 border-theme_blue rounded-md shadow-[0px_2px_8px_2px_rgba(0,0,0,0.05)] gap-4 hover:bg-dark_blue hover:text-white">
