...
const Description = () => {
  ...
  return (
    <div>
      {/* who we are  */}
      <div className="grid lg:grid-cols-5 md:grid-cols-1 sm:grid-col-1 text-3xl gap-10 max-w-7xl px-4 mx-auto mt-16">
          {/* description  */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-7xl px-4 mx-auto mt-20   relative">
        ...
        <div className="flex flex-col justify-between items-center 	gap-8	">
          ...
          <section class="w-96	">
            <div class="flex  h-full bg-gray-100 p-8 flex-col bg-[#02135C] text-white">
              <div class="flex items-center mb-3">
                <img className='w-[50px] mr-5	' src="/Assets/About/mission.svg" alt="" />
                <h2 class="text-white	 text-xl title-font font-medium">Our Mission</h2>
              </div>
              <div class="flex-grow">
