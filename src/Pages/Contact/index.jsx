    ...
    return (
        <div className="bg-[#F5F5F5]">
            ...
            <div className='overflow-hidden'>
                ...
                <div className='max-w-7xl mx-auto min-h-[715px] relative'>
                    ...
                    <div className='bg-[#0568E5] absolute rounded-[31px] h-[621px] bottom-9 left-32 w-[91%] z-[3]'></div>

                    <div className='bg-[#00146B] absolute rounded-[31px] h-[621px] bottom-5 left-[230px] w-[84%] z-[2]'></div>
                </div>
