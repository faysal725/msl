            ...
            <div className="max-w-7xl mx-auto relative pt-16 pb-5 flex flex-col gap-5">
                        ...
                        <div className="col-span-12 lg:col-span-7 px-5">
                            <form action="">
                                <div className="rounded-full overflow-hidden bg-white grid grid-cols-12">
                                    <input type="text" placeholder='Enter your email' name="" id="" className='col-span-8 py-3 px-6 text-slate-900' />
                ...
                <div className='px-4 pt-16 md:pt-20 lg:pt-4'>
                    <div className="py-4 md:py-0">
                        <img src="/Assets/logo.svg" className='mx-auto md:mx-0' alt="logo" />
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row items-center md:items-start justify-between text-sm'>
                        <div className=''>
                            ...
                            <div className="flex flex-col items-center md:items-start gap-2 my-6 w-72">
                                ...
                                <p className="">44/F/7, 2nd Floor, Rangan Tower,
                            ...
                            <div className="flex flex-col items-center md:items-start gap-2">
                                ...
                                <p className="">info@mistrisolutions.com</p>
                            </div>
                        </div>

                        <div className='flex flex-col items-center md:items-start gap-6 font-bold my-6'>
                            <Link className='transition-all hover:underline hover:underline-offset-4' to="/">FAQ</Link>
                            <Link className='transition-all hover:underline hover:underline-offset-4' to="/" >Terms of Service</Link>
                            <Link className='transition-all hover:underline hover:underline-offset-4' to="/" >Privacy Policy</Link>
                        </div>
                ...
                <div className="text-center">
                    <p>Copyright &copy;2022, Mistrisolutions </p>
